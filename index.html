...
@media only screen and (max-width: 700px){
  ...
  <div id="navbar-right">
    <a type="link" class="btn btn-link active" href="https://thecolosseum.user303.repl.co/features.html">Features</a>
    <a type="link" class="btn btn-link" href="https://thecolosseum.user303.repl.co/index.html">Credits</a>
    <script>
